...
print("===============================")
print("===============================")
print("Making neural Network without Con2D and MAxPooling")
...
print("Prediction Complete for X_test witout Conv2D and MaxPooling")
print("===============================")
...
print("===============================")
print("===============================")
print("Making neural Network 10 Epoches, better learning rate , with Con2D and MAxPooling layers to enhance accuracy")
...
model1.fit(X,Y_train_categorical,epochs=10 )
print("===============================")
print("Learning complete")
print("===============================")
print("===============================")
...
print("Prediction Complete for X_test with Conv2D and MaxPooling")
print("===============================")
np.shape(model1.predict(X_test))
